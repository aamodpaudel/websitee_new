  ...
  return (
    ...
    >
      ...
      >
        ...
        <span className="block mt-1 text-pink-600">in minutes</span>
      </motion.h1>
      ...
      >
        Navigate your professional journey with personalized guidance, expert
      ...
      >
        <div className="flex flex-col sm:flex-row items-center gap-3 justify-center lg:justify-start">
          <Link href={CAREER_GPS_URL} className="w-full sm:w-auto">
            <Button
              size="lg"
...
export default function CareerChargePromo() {
  return (
