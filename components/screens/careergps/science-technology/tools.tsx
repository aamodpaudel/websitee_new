...
import CareerTools from "../../careeragents/careerStagetools";

const ScienceToolsData = [
  {
...
export default function ScienceTools() {
  return (
    <CareerTools
      tools={ScienceToolsData}
      explore_tool_link={COMMUNITY_URL + "/careergps"}
      career_stage="Science & Technology"
      description="Explore the tools and resources available to help you navigate your career journey in Science & Technology."
    />
  );
}
