...
const TextSection = () => {
  ...
  return (
    ...
    >
      ...
      >
        Ready to <span className="mt-1 text-pink-600">Grow?</span>
      </motion.h1>
      ...
      >
        Join Career Circle today and take the next step in your professional
        journey.
      </motion.p>
      ...
      >
        <div className="flex flex-col sm:flex-row items-center gap-3 justify-center lg:justify-start">
          <Link href="/portal/individual" className="w-full sm:w-auto">
            <Button
              size="lg"
...
export default function CareerCirclePromo() {
  return (
